...
window.confirm("enter username:- username")
window.confirm("enter email:-  email@123")
window.confirm("enter password:- password")
window.confirm("enter phoneno:- 1234567890")

localStorage.setItem("user", "username")
localStorage.setItem("email", "email@123")
localStorage.setItem("pass", "password")
localStorage.setItem("phone", "1234567890")
let s11 = localStorage.getItem("user")
let s22 = localStorage.getItem("email")
let s33 = localStorage.getItem("pass")
let s44 = localStorage.getItem("phone")
